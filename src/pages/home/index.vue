<template>
		...
		<div class="block">
			...
			<div class="main">
				<div class="wrapper-4">
					...
					<span class="summary">今天咱们也找到了一份猫咪的性格测试问卷，来自ASPCA的Feline-ality™计划，最终将猫咪划分</span>
	...
	<cg-pop-pay :isShow="state.isPopShow" @onClickMask="handleMask" @onClickPass="handlePass" />
</template>
...
const getUserInfo = () => {
	...
	// 		console.log('在这里将 encryptedData 和 iv 传给后端解密获取用户信息:', res);
	// 	}
	// });
	Taro.login({
		success: (res) => {
